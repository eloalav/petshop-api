...
from activate_this import filtrar_por_product, filtrar_por_description, filtrar_por_price
...
def listar_produtos():
    ...
    if product_name and product_description and product_price:
        lista_product = filtrar_por_product(products, product_name)
        lista_product_description = filtrar_por_description(lista_product, product_description)
        lista_product_price = filtrar_por_price(lista_product_description, float(product_price))
        return jsonify(lista_product_price)
    ...
    if product_description:
        lista_product_description = filtrar_por_description(products, product_description)
        return jsonify(lista_product_description)

    if product_price:
        lista_filtrada_por_price = filtrar_por_price(products, float(product_price))
        return jsonify(lista_filtrada_por_price)
...
def products_baratos():
    ...
    for product in products:
        if product['product_price'] < valor_maximo:
